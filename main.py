...
class ScraperGUI:
    def __init__(self, root):
        ...
        # CSS Selector Entry
        self.css_selector_label = tk.Label(root, text="Enter CSS Selector:")
        self.css_selector_label.pack()
        self.css_selector_entry = tk.Entry(root, width=50)
        self.css_selector_entry.pack()
    ...
    def scrape(self):
        ...
        if not css_selector:
            messagebox.showerror("Error", "CSS Selector cannot be empty!")
            return
        ...
        try:
            print(f"Scraping data for CSS Selector: {css_selector}")  # Debugging line
            data = scrape_web(url, css_selector)
